...
;(function (console, $hx_exports) {
  ...
  coopy.Alignment.prototype = {
    ...
    link: function (a, b) {
      if (a != -1) this.map_a2b.h[a] = b
      else this.has_addition = true
      if (b != -1) this.map_b2a.h[b] = a
      else this.has_removal = true
      this.map_count++
    },
    ...
    toString: function () {
      var result =
        '' + this.map_a2b.toString() + ' // ' + this.map_b2a.toString()
  ...
  coopy.CompareTable.prototype = {
    ...
    alignCore2: function (align, a, b) {
        ...
        if (unit.l >= 0 && unit.r >= 0 && unit.p != -1) {
          if (ignore != null) {
            if (unit.l >= 0 && ra_header >= 0 && ra_header < a.get_height()) {
              ...
              if (
                __map_reserved[name] != null
                  ? ignore.existsReserved(name)
                  : ignore.h.hasOwnProperty(name)
              )
                continue
            }
            if (unit.r >= 0 && rb_header >= 0 && rb_header < b.get_height()) {
              ...
              if (
                __map_reserved[name1] != null
                  ? ignore.existsReserved(name1)
                  : ignore.h.hasOwnProperty(name1)
              )
                continue
            }
          }
      ...
      if (ids != null) {
        ...
        while (_g2 < ids.length) {
          ...
          ++_g2
          {
            if (__map_reserved[id] != null) ids_as_map.setReserved(id, true)
            else ids_as_map.h[id] = true
            true
          }
        }
        var _g3 = 0
        while (_g3 < common_units.length) {
          ...
          if (
            (__map_reserved[na] != null
              ? ids_as_map.existsReserved(na)
              : ids_as_map.h.hasOwnProperty(na)) ||
            (__map_reserved[nb] != null
              ? ids_as_map.existsReserved(nb)
              : ids_as_map.h.hasOwnProperty(nb))
          ) {
        ...
        if (common_units.length > N) {
            ...
            while (_g21 < ha) {
              ...
              if (
                !(__map_reserved[key] != null
                  ? mem.existsReserved(key)
                  : mem.h.hasOwnProperty(key))
              ) {
                if (__map_reserved[key] != null) mem.setReserved(key, 1)
                else mem.h[key] = 1
                ct++
              }
            }
            ...
            while (_g22 < hb) {
              ...
              if (
                !(__map_reserved[key1] != null
                  ? mem2.existsReserved(key1)
                  : mem2.h.hasOwnProperty(key1))
              ) {
                if (__map_reserved[key1] != null) mem2.setReserved(key1, 1)
                else mem2.h[key1] = 1
                ct++
              }
            }
          ...
          columns = Lambda.array(
            Lambda.map(columns_eval, function (v) {
              return v[0]
            })
          )
    ...
    alignColumns: function (align, a, b) {
        ...
        while (_g1 < slop) {
          ...
          if (ra < a.get_height()) {
            ...
            while (_g3 < _g2) {
              ...
              if (
                __map_reserved[key] != null
                  ? ma.existsReserved(key)
                  : ma.h.hasOwnProperty(key)
              ) {
                if (__map_reserved[key] != null) ma.setReserved(key, -1)
                else ma.h[key] = -1
                uniques--
              } else {
                if (__map_reserved[key] != null) ma.setReserved(key, ca)
                else ma.h[key] = ca
                uniques++
              }
            }
          ...
          if (rb < b.get_height()) {
            ...
            while (_g31 < _g21) {
              ...
              if (
                __map_reserved[key1] != null
                  ? mb.existsReserved(key1)
                  : mb.h.hasOwnProperty(key1)
              ) {
                if (__map_reserved[key1] != null) mb.setReserved(key1, -1)
                else mb.h[key1] = -1
                uniques--
              } else {
                if (__map_reserved[key1] != null) mb.setReserved(key1, cb)
                else mb.h[key1] = cb
                uniques++
              }
            }
          ...
          while ($it0.hasNext()) {
            ...
            var i0
            i0 =
              __map_reserved[key2] != null ? ma.getReserved(key2) : ma.h[key2]
            var i1
            i1 =
              __map_reserved[key2] != null ? mb.getReserved(key2) : mb.h[key2]
            if (i1 != null) {
              if (i1 >= 0 && i0 >= 0) ct++
            }
          }
      ...
      if (ma_best == null) {
        if (a.get_height() > 0 && b.get_height() == 0) align.headers(0, -1)
        else if (a.get_height() == 0 && b.get_height() > 0) align.headers(-1, 0)
        return
      }
      ...
      while ($it1.hasNext()) {
        ...
        i01 =
          __map_reserved[key3] != null
            ? ma_best.getReserved(key3)
            : ma_best.h[key3]
        var i11
        i11 =
          __map_reserved[key3] != null
            ? mb_best.getReserved(key3)
            : mb_best.h[key3]
        if (i01 != null && i11 != null) align.link(i01, i11)
        else if (i01 != null) align.link(i01, -1)
        else if (i11 != null) align.link(-1, i11)
      }
      ...
      while ($it2.hasNext()) {
        ...
        var i02
        i02 =
          __map_reserved[key4] != null
            ? ma_best.getReserved(key4)
            : ma_best.h[key4]
        var i12
        i12 =
          __map_reserved[key4] != null
            ? mb_best.getReserved(key4)
            : mb_best.h[key4]
  ...
  coopy.Coopy.adapter = function (local, remote, flags) {
    var comp = new coopy.TableComparisonState()
    var td = coopy.Coopy.align(local, remote, flags, comp)
    var o = coopy.Coopy.getBlankTable(td, comp)
    if (comp.a != null) o = comp.a.create()
  ...
  coopy.Coopy.patch = function (local, patch, flags) {
    var patcher = new coopy.HighlightPatch(
      coopy.Coopy.tablify(local),
      coopy.Coopy.tablify(patch)
    )
  ...
  coopy.Coopy.jsonify = function (t) {
    ...
    if (__map_reserved.sheet != null) workbook.setReserved('sheet', sheet)
    else workbook.h['sheet'] = sheet
    return workbook
  }
  coopy.Coopy.tablify = function (data) {
    ...
    return new (typeof window != 'undefined' ? window : exports).daff.TableView(
      data
    )
  }
  coopy.Coopy.prototype = {
    ...
    checkFormat: function (name) {
      ...
      this.nested_output =
        this.format_preference == 'json' || this.format_preference == 'ndjson'
    ...
    applyRenderer: function (name, renderer) {
      ...
      else this.saveText(name, renderer.html())
    ...
    saveText: function (name, txt) {
      if (name == null) this.cache_txt += txt
      else if (name != '-') this.io.saveContent(name, txt)
      else this.io.writeStdout(txt)
      return true
    },
    ...
    runDiff: function (parent, a, b, flags, output) {
      ...
      if (flags.terminal_format == null) {
        if (
          (output == null || output == '-') &&
          (this.output_format == 'copy' || this.output_format == 'csv')
        ) {
          if (this.io != null) {
    ...
    installGitDriver: function (io, formats) {
      ...
      while (_g2 < formats.length) {
        ...
        if (!this.status.exists(key)) {
          r = this.command(io, 'git', [
            'config',
            '--global',
            '--get',
            'diff.daff-' + format1 + '.command'
          ])
          if (r == 999) return r
          this.status.set(key, r)
        }
        ...
        if (!this.status.exists(key)) {
          r = this.command(io, 'git', [
            ...
            '--global',
            'diff.daff-' + format1 + '.command',
            this.daff_cmd + ' diff --git'
          ])
          if (r == 999) return r
          if (have_diff_driver)
            io.writeStdout(
              '- Cleared existing daff diff driver for ' + format1 + '\n'
            )
        ...
        if (!this.status.exists(key)) {
          if (!have_merge_driver) {
            r = this.command(io, 'git', [
              'config',
              '--global',
              'merge.daff-' + format1 + '.name',
              'daff tabular ' + format1 + ' merge'
            ])
            if (r == 999) return r
          } else r = 0
          this.status.set(key, r)
        ...
        if (!this.status.exists(key)) {
          r = this.command(io, 'git', [
            ...
            '--global',
            'merge.daff-' + format1 + '.driver',
            this.daff_cmd + ' merge --output %A %O %A %B'
          ])
          if (r == 999) return r
          if (have_merge_driver)
            io.writeStdout(
              '- Cleared existing daff merge driver for ' + format1 + '\n'
            )
      ...
      if (!io.exists('.git/config')) {
        io.writeStderr(
          '! This next part needs to happen in a git repository.\n'
        )
        io.writeStderr(
          '! Please run again from the root of a git repository.\n'
        )
        return 1
      }
      ...
      while (_g3 < formats.length) {
        ...
        if (txt.indexOf('*.' + format2) >= 0)
          io.writeStderr(
            '- Your .gitattributes file already mentions *.' + format2 + '\n'
          )
        else {
    ...
    run: function (args, io) {
        ...
        while (_g1 < _g) {
          ...
          if (tag == '--output') {
            ...
            if (this.flags.acts == null)
              this.flags.acts = new haxe.ds.StringMap()
            {
      ...
      if (args.length < 2) {
        ...
        io.writeStderr(
          '     --input-format [csv|tsv|ssv|json]: set format to expect for input\n'
        )
        io.writeStderr(
        ...
        io.writeStderr(
          '     --output-format [csv|tsv|ssv|json|copy|html]: set format for output\n'
        )
        io.writeStderr(
      ...
      if (git) {
        ...
        if (ct != 7 && ct != 9) {
          io.writeStderr(
            'Expected 7 or 9 parameters from git, but got ' + ct + '\n'
          )
          return 1
        }
      ...
      if (args.length - offset >= 2) {
        if (cmd1 != 'copy') b = this.loadTable(args[1 + offset])
        else output = args[1 + offset]
      }
      ...
      if (cmd1 == 'diff') {
        ...
        this.saveTable(output, a)
      } else if (cmd1 == 'trim') this.saveTable(output, a)
      else if (cmd1 == 'render') this.renderTable(output, a)
      else if (cmd1 == 'copy') this.saveTable(output, a)
      if (ok) return 0
      else return 1
    },
    coopyhx: function (io) {
  ...
  coopy.DiffRender.examineCell = function (
    x,
    y,
    view,
    raw,
    ...
    if (vcol.indexOf('+++') >= 0) cell.category_given_tr = cell.category = 'add'
    else if (vcol.indexOf('---') >= 0) {
      cell.category_given_tr = cell.category = 'remove'
      removed_column = true
    }
    if (vrow == '!') cell.category = 'spec'
    else if (vrow == '@@') cell.category = 'header'
    else if (vrow == '...') cell.category = 'gap'
    else if (vrow == '+++') {
      if (!removed_column) cell.category = 'add'
    } else if (vrow == '---') cell.category = 'remove'
      ...
      if (!removed_column) {
        ...
        if (nested || str.indexOf(part) >= 0) {
          ...
          var div = part
          if (part != full) {
            if (nested) cell.conflicted = view.hashExists(raw, 'theirs')
            else cell.conflicted = str.indexOf(full) >= 0
            if (cell.conflicted) {
              div = full
              cat = 'conflict'
            }
          ...
          if (nested) {
            ...
            if (cell.pretty_value == div) tokens = ['', '']
            else tokens = cell.pretty_value.split(div)
          }
  ...
  coopy.DiffRender.prototype = {
    ...
    insertCell: function (txt, mode) {
      ...
      if (txt != null) this.insert(txt)
      else this.insert('null')
    ...
    render: function (tab) {
      ...
      while (_g1 < _g) {
        ...
        while (_g3 < _g2) {
          ...
          render.insertCell(
            this.pretty_arrows ? cell.pretty_value : cell.value,
            cell.category_given_tr
          )
        }
        render.endRow()
  ...
  coopy.FlatCellBuilder.prototype = {
    ...
    update: function (local, remote) {
      return this.view.toDatum(
        coopy.FlatCellBuilder.quoteForDiff(this.view, local) +
          this.separator +
          coopy.FlatCellBuilder.quoteForDiff(this.view, remote)
      )
    },
    conflict: function (parent, local, remote) {
      return (
        this.view.toString(parent) +
        this.conflict_separator +
        this.view.toString(local) +
        this.conflict_separator +
        this.view.toString(remote)
      )
    },
  ...
  coopy.HighlightPatch = $hx_exports.coopy.HighlightPatch = function (
    source,
    patch,
    flags
  ) {
  ...
  coopy.HighlightPatch.prototype = {
    ...
    apply: function () {
      ...
      if (corner == '@:@') this.rcOffset = 1
      else this.rcOffset = 0
      var _g1 = 0
    ...
    setMetaProp: function (target, column_name, prop_name, value) {
      ...
      if (
        !(__map_reserved[column_name] != null
          ? target.existsReserved(column_name)
          : target.h.hasOwnProperty(column_name))
      ) {
        var value1 = []
        if (__map_reserved[column_name] != null)
          target.setReserved(column_name, value1)
        else target.h[column_name] = value1
      }
      ...
      change.val = value
      ;(__map_reserved[column_name] != null
        ? target.getReserved(column_name)
        : target.h[column_name]
      ).push(change)
    },
    applyMetaRow: function (code) {
      ...
      while (_g1 < _g) {
        ...
        var idx_patch = i
        var idx_src
        if (this.patchInSourceCol.h.hasOwnProperty(idx_patch))
          idx_src = this.patchInSourceCol.h[idx_patch]
        else idx_src = -1
        var prev_name = null
        var name = null
        ...
        if (this.cellInfo.updated) {
          this.setMetaProp(
            ...
            prev_name,
            prop_name,
            this.cellInfo.lvalue
          )
          this.setMetaProp(
            this.next_meta,
            name,
            prop_name,
            this.cellInfo.rvalue
          )
        } else {
          this.setMetaProp(
            this.prev_meta,
    ...
    applyRow: function (r) {
      ...
      var done = false
      if (r == 0 && this.rcOffset > 0) done = true
      else if (code == '@@') {
        ...
        this.flags.addWarning(
          "cannot usefully apply diffs with metadata yet: '" + code + "'"
        )
        this.preambleRow = r
      ...
      if (!done) {
        this.finishColumns()
        if (code == '+++') this.applyAction(code)
        else if (code == '---') this.applyAction(code)
        else if (code == '+' || code == ':') this.applyAction(code)
        else if (code.indexOf('->') >= 0) this.applyAction('->')
        else this.lastSourceRow = -1
      }
    },
    getDatum: function (c) {
    ...
    processMods: function (rmods, fate, len) {
      ...
      while (_g < rmods.length) {
        ...
        else if (mod.rem || mod.add) last = -1
      }
      if (last != -1) {
        var _g3 = last
        while (_g3 < len) {
    ...
    finishRows: function () {
      ...
      if (this.rowPermutation.length > 0)
        this.source.insertOrDeleteRows(
          this.rowPermutation,
          this.rowPermutation.length
        )
      ...
      while (_g2 < _g11.length) {
        ...
        if (!mod1.rem) {
          if (mod1.add) {
            ...
            while ($it0.hasNext()) {
              ...
              if (offset != null && offset >= 0)
                this.source.setCell(
                  offset,
                  mod1.destRow,
                  this.patch.getCell(c, mod1.patchRow)
                )
            }
          } else if (mod1.update) {
            ...
            while ($it1.hasNext()) {
              var c1 = $it1.next()
              var txt = this.view.toString(
                this.patch.getCell(c1, mod1.patchRow)
              )
              coopy.DiffRender.examineCell(
                0,
                0,
              ...
              var d = this.view.toDatum(
                this.csv.parseCell(this.cellInfo.rvalue)
              )
      ...
      if (this.headerMove != null) {
        if (this.colPermutation.length > 0) {
          ...
          if (!this.useMetaForColumnChanges())
            this.source.insertOrDeleteColumns(
              this.colPermutation,
              this.colPermutation.length
            )
        }
      }
  ...
  coopy.JsonTables = function (json, flags) {
    ...
    if (flags != null && flags.tables != null) {
      ...
      while (_g < _g1.length) {
        var name = _g1[_g]
        ++_g
        if (__map_reserved[name] != null) allowed.setReserved(name, true)
        else allowed.h[name] = true
      }
      count = 0
      var _g2 = 0
      while (_g2 < names.length) {
        ...
        if (
          __map_reserved[name1] != null
            ? allowed.existsReserved(name1)
            : allowed.h.hasOwnProperty(name1)
        )
          count++
      }
    }
    ...
    while (_g3 < names.length) {
      ...
      if (allowed != null) {
        if (
          !(__map_reserved[name2] != null
            ? allowed.existsReserved(name2)
            : allowed.h.hasOwnProperty(name2))
        )
          continue
      }
  ...
  coopy.Merger = $hx_exports.coopy.Merger = function (
    parent,
    local,
    remote,
    flags
  ...
  coopy.Merger.prototype = {
    ...
    shuffleColumns: function () {
      ...
      var fate = []
      var wfate = this.shuffleDimension(
        this.column_units,
        this.local.get_width(),
        fate,
        this.column_mix_local,
        this.column_mix_remote
      )
    ...
    shuffleRows: function () {
      ...
      var fate = []
      var hfate = this.shuffleDimension(
        this.units,
        this.local.get_height(),
        fate,
        this.row_mix_local,
        this.row_mix_remote
      )
              ...
              if (!view.equals(pcell, rcell)) {
                ...
                if (view.equals(pcell, lcell))
                  ...
                  this.local.setCell(
                    col.l,
                    row.l,
                    coopy.Merger.makeConflictedCell(view, pcell, lcell, rcell)
                  )
                  this.conflicts++
                }
              }
      ...
      while ($it0.hasNext()) {
        ...
        while (_g4 < _g11.length) {
          ...
          if (unit.l >= 0 && unit.r >= 0)
            this.local.setCell(
              x2,
              this.row_mix_local.h[unit.l],
              this.remote.getCell(x, unit.r)
            )
          else if (unit.p < 0 && unit.r >= 0)
            this.local.setCell(
              x2,
              this.row_mix_remote.h[unit.r],
              this.remote.getCell(x, unit.r)
            )
        }
      }
      ...
      while ($it1.hasNext()) {
        ...
        while (_g5 < _g12.length) {
          ...
          if (unit1.l >= 0 && unit1.r >= 0)
            this.local.setCell(
              this.column_mix_local.h[unit1.l],
              y2,
              this.remote.getCell(unit1.r, y)
            )
        }
      }
  ...
  coopy.RowChange.prototype = {
    ...
    toString: function () {
      return (
        this.action +
        ' ' +
        this.showMap(this.cond) +
        ' : ' +
        this.showMap(this.val)
      )
    },
  ...
  coopy.SimpleMeta = $hx_exports.coopy.SimpleMeta = function (
    t,
    has_properties,
    may_be_nested
  ) {
  ...
  coopy.SimpleMeta.prototype = {
    ...
    alterColumns: function (columns) {
      ...
      if (this.has_properties) {
        if (__map_reserved['@'] != null) target.setReserved('@', wfate)
        else target.h['@'] = wfate
        wfate++
      }
      var _g1 = 0
      ...
      while (_g11 < _g2) {
        ...
        if (
          __map_reserved[name] != null
            ? target.existsReserved(name)
            : target.h.hasOwnProperty(name)
        )
          targeti =
            __map_reserved[name] != null
              ? target.getReserved(name)
              : target.h[name]
        fate.push(targeti)
      }
      this.t.insertOrDeleteColumns(fate, wfate)
      var start
      if (this.has_properties) start = 1
      else start = 0
      var at = start
      var _g12 = 0
  ...
  coopy.SimpleView.prototype = {
    ...
    hashExists: function (h, str) {
      var hh = h
      if (__map_reserved[str] != null) return hh.existsReserved(str)
      else return hh.h.hasOwnProperty(str)
    },
  ...
  coopy.SqlCompare = $hx_exports.coopy.SqlCompare = function (
    db,
    local,
    remote,
    alt,
    ...
    if (local != null && remote != null) {
      if (this.remote.getDatabase().getNameForAttachment() != null) {
        if (
          this.remote.getDatabase().getNameForAttachment() !=
    ...
    if (this.alt != null && local != null) {
      if (this.alt.getDatabase().getNameForAttachment() != null) {
        if (
          this.alt.getDatabase().getNameForAttachment() !=
          this.local.getDatabase().getNameForAttachment()
        ) {
          local
            .getDatabase()
  ...
  coopy.SqlCompare.prototype = {
    ...
    scanColumns: function (
      ...
      while (_g1 < _g) {
        ...
        if (
          __map_reserved[key] != null
            ? present2.existsReserved(key)
            : present2.h.hasOwnProperty(key)
        )
          align.meta.link(
            i,
            __map_reserved[key] != null
              ? present2.getReserved(key)
              : present2.h[key]
          )
        else align.meta.link(i, -1)
      }
      var _g11 = 0
      ...
      while (_g11 < _g2) {
        ...
        if (
          !(__map_reserved[key1] != null
            ? present1.existsReserved(key1)
            : present1.h.hasOwnProperty(key1))
        )
      ...
      while (_g3 < key_cols.length) {
        ...
        var unit = new coopy.Unit(
          __map_reserved[key2] != null
            ? present1.getReserved(key2)
            : present1.h[key2],
          __map_reserved[key2] != null
            ? present2.getReserved(key2)
            : present2.h[key2]
        )
    ...
    apply: function () {
      ...
      while (_g11 < _g2) {
        ...
        if (__map_reserved[key] != null) present1.setReserved(key, i1)
        else present1.h[key] = i1
      }
      var _g12 = 0
      ...
      while (_g12 < _g3) {
        ...
        if (
          ...
          has_column_add = true
        if (__map_reserved[key1] != null) present2.setReserved(key1, i2)
        else present2.h[key1] = i2
      }
      var _g13 = 0
      ...
      while (_g13 < _g4) {
        ...
        if (
          !(__map_reserved[key2] != null
            ? present1.existsReserved(key2)
            : present1.h.hasOwnProperty(key2))
        )
          has_column_add = true
        if (__map_reserved[key2] != null) present3.setReserved(key2, i3)
        else present3.h[key2] = i3
        if (
          __map_reserved[key2] != null
            ? present1.existsReserved(key2)
            : present1.h.hasOwnProperty(key2)
          ...
          if (
            __map_reserved[key2] != null
              ? present2.existsReserved(key2)
              : present2.h.hasOwnProperty(key2)
          ) {
            all_common_cols.push(key2)
            if (
              !(__map_reserved[key2] != null
                ? present_primary.existsReserved(key2)
                : present_primary.h.hasOwnProperty(key2))
            )
      ...
      while (_g14 < _g5) {
        ...
        if (
          __map_reserved[key3] != null
            ? present2.existsReserved(key3)
            : present2.h.hasOwnProperty(key3)
        )
          this.align.meta.link(
            i4,
            __map_reserved[key3] != null
              ? present2.getReserved(key3)
              : present2.h[key3]
          )
        else this.align.meta.link(i4, -1)
      }
      var _g15 = 0
      ...
      while (_g15 < _g6) {
        ...
        if (
          !(__map_reserved[key4] != null
            ? present1.existsReserved(key4)
            : present1.h.hasOwnProperty(key4))
        )
      ...
      if (this.alt != null) {
        ...
        while (_g112 < _g22) {
          ...
          sql_key_match3 +=
            sql_table1 + '.' + n1 + ' IS ' + sql_table3 + '.' + n1
        }
      }
      ...
      while (_g113 < _g23) {
        ...
        sql_data_mismatch +=
          sql_table1 + '.' + n2 + ' IS NOT ' + sql_table2 + '.' + n2
      }
      var _g114 = 0
      ...
      while (_g114 < _g24) {
        ...
        if (
          !(__map_reserved[key5] != null
            ? present1.existsReserved(key5)
            : present1.h.hasOwnProperty(key5))
        ) {
      ...
      if (this.alt != null) {
        ...
        while (_g115 < _g25) {
          ...
          sql_data_mismatch +=
            sql_table1 + '.' + n4 + ' IS NOT ' + sql_table3 + '.' + n4
        }
        var _g116 = 0
        ...
        while (_g116 < _g26) {
          ...
          if (
            !(__map_reserved[key6] != null
              ? present1.existsReserved(key6)
              : present1.h.hasOwnProperty(key6))
          ) {
            if (sql_data_mismatch != '') sql_data_mismatch += ' OR '
      ...
      if (this.remote != null) {
        ...
        if (this.local != null)
          sql_inserts +=
            ...
            sql_table1 +
            this.where(sql_key_match2) +
            ')'
        var sql_inserts_order = [
          '__coopy_code',
          'NULL',
          'rowid',
          'NULL'
      ...
      if (this.alt != null) {
        var sql_inserts1 =
          'SELECT DISTINCT 1 AS __coopy_code, NULL, NULL, ' +
          rowid +
          ' AS rowid, ' +
          sql_all_cols3 +
          ' FROM ' +
        ...
        if (this.local != null)
          sql_inserts1 +=
            ' WHERE NOT EXISTS (SELECT 1 FROM ' +
            sql_table1 +
            this.where(sql_key_match3) +
            ')'
        var sql_inserts_order1 = [
          '__coopy_code',
          'NULL',
          'NULL',
          'rowid'
      ...
      if (this.local != null && this.remote != null) {
        var sql_updates =
          ...
          rowid2 +
          ' AS __coopy_rowid1, '
        if (this.alt != null) sql_updates += rowid3 + ' AS __coopy_rowid2,'
        else sql_updates += ' NULL,'
      ...
      if (this.alt != null) {
        ...
        if (this.remote != null)
          sql_deletes1 +=
            ' LEFT OUTER JOIN ' + sql_table2 + ' ON ' + sql_key_match2
        sql_deletes1 +=
          ' LEFT OUTER JOIN ' + sql_table3 + ' ON ' + sql_key_match3
        sql_deletes1 +=
          ' WHERE __coopy_rowid1 IS NULL OR __coopy_rowid2 IS NULL'
        var sql_deletes_order1 = [
          '__coopy_code',
          '__coopy_rowid0',
          '__coopy_rowid1',
          '__coopy_rowid2'
  ...
  coopy.SqlTable.prototype = {
    ...
    getRowStream: function () {
      this.getColumns()
      this.db.begin(
        'SELECT * FROM ' + this.getQuotedTableName() + ' ORDER BY ?',
        [this.db.rowid()],
        this.columnNames
      )
      return this
  ...
  coopy.SqlTableName = $hx_exports.coopy.SqlTableName = function (
    name,
    prefix
  ) {
  ...
  coopy.SqlTables = $hx_exports.coopy.SqlTables = function (db, flags) {
    ...
    while (_g3 < names.length) {
      ...
      this.t.setCell(
        1,
        at,
        v.wrapTable(new coopy.SqlTable(db, new coopy.SqlTableName(name2)))
      )
      at++
    }
  }
  ...
  coopy.SqliteHelper.prototype = {
    ...
    update: function (db, name, conds, vals) {
      ...
      while ($it1.hasNext()) {
        ...
        q += ' IS ?'
        lst.push(
          __map_reserved[k1] != null ? conds.getReserved(k1) : conds.h[k1]
        )
      }
      if (!db.begin(q, lst, [])) {
  ...
  coopy.TableDiff.prototype = {
      ...
      if (del > 0 && active != null) {
        ...
        while (_g1 < _g) {
          ...
          if (active[i] == 0 || active[i] == 3) {
            if (i - mark <= del + skips) active[i] = 2
            else if (i - mark == del + 1 + skips) active[i] = 3
          } else if (active[i] == 1) {
            mark = i
            skips = 0
          }
        ...
        while (_g11 < _g2) {
          ...
          if (active[i1] == 0 || active[i1] == 3) {
            if (mark - i1 <= del + skips) active[i1] = 2
            else if (mark - i1 == del + 1 + skips) active[i1] = 3
          } else if (active[i1] == 1) {
            mark = i1
            skips = 0
          }
    ...
    setupColumns: function () {
      ...
      if (ignore != null) {
        ...
        while (_g1 < _g) {
          ...
          if (
            p_ignore.h.hasOwnProperty(cunit.p) ||
            a_ignore.h.hasOwnProperty(cunit.l) ||
            b_ignore.h.hasOwnProperty(cunit.r)
          )
            continue
    ...
    scanSchema: function () {
      ...
      while (_g1 < _g) {
        ...
        if (cunit.r >= 0 && cunit.lp() >= 0) {
          if (
            this.p.get_height() >= this.rp_header &&
            this.b.get_height() >= this.rb_header
          ) {
    ...
    checkRcNumbers: function (w, h) {
      if (!this.show_rc_numbers) {
        if (this.flags.always_show_order) this.show_rc_numbers = true
          ...
          if (cunit.r >= 0) {
            ...
            if (this.p.get_height() != 0)
              output.setCell(
                j + 1,
                at,
                this.p.getCell(cunit.lp(), this.rp_header)
              )
          }
    ...
    addMeta: function (output) {
      ...
      var meta_align = coopy.Coopy.compareTables3(
        a_meta == p_meta ? null : p_meta,
        a_meta,
        b_meta,
        meta_flags
      ).align()
      ...
      if (td.hasDifference()) {
        ...
        var offset
        if (td.hasSchemaDifference()) offset = 2
        else offset = 1
        ...
        while (_g < dh) {
          ...
          while (_g2 < _g1) {
            ...
            if (x == 1)
              c =
                '@' + v.toString(c) + '@' + v.toString(meta_diff.getCell(0, y))
    ...
    refineActivity: function () {
      this.spreadContext(
        this.row_units,
        this.flags.unchanged_context,
        this.active_row
      )
      this.spreadContext(
        this.column_units,
        this.flags.unchanged_column_context,
        this.active_column
      )
      if (this.active_column != null) {
        var _g1 = 0
    ...
    checkNesting: function (v, have_ll, ll, have_rr, rr, have_pp, pp, x, y) {
      ...
      var pp_out = null
      if (
        comp.alignment.isMarkedAsIdentical() ||
        (have_ll && !have_rr) ||
        (have_rr && !have_ll)
      ) {
        ll_out = '[' + key + ']'
    ...
    scanRow: function (unit, output, at, i) {
      ...
      while (_g1 < _g) {
        ...
        if (have_pp) {
          if (!have_rr) dd = pp
          else if (this.isEqual(this.v, pp, rr)) dd = ll
          else {
            dd = pp
            dd_to = rr
            have_dd_to = true
          ...
          if (!have_rr) dd = ll
          else if (this.isEqual(this.v, ll, rr)) dd = ll
          else {
            dd = ll
            dd_to = rr
            have_dd_to = true
        ...
        if (have_dd_to && this.allow_update) {
          ...
          if (!is_conflict) {
            ...
            if (this.conflict_sep == '') {
              if (this.builder.needSeparator()) {
                this.conflict_sep =
                  this.getSeparator(this.p, this.a, '!') + this.sep
    ...
    hiliteSingle: function (output) {
      ...
      if (this.builder == null) {
        ...
        else this.builder = new coopy.FlatCellBuilder(this.flags)
      }
      output.resize(0, 0)
      output.clear()
      this.reset()
    ...
    getText: function (x, y, color) {
      ...
      if (color) {
        ...
        if (code != null) {
          if (cell.rvalue != null) {
            val =
              this.codes.get('remove') +
              cell.lvalue +
              this.codes.get('modify') +
              cell.pretty_separator +
              this.codes.get('add') +
              cell.rvalue +
              this.codes.get('done')
  ...
  coopy.Unit.prototype = {
    lp: function () {
      if (this.p == -2) return this.l
      else return this.p
    },
    toString: function () {
      if (this.p >= -1)
        return (
          coopy.Unit.describe(this.p) +
          '|' +
          coopy.Unit.describe(this.l) +
          ':' +
          coopy.Unit.describe(this.r)
        )
  ...
  coopy.Viterbi.prototype = {
    ...
    addTransition: function (s0, s1, c) {
      ...
      if (sourced) {
        if (
          c < this.cost.get(s1, this.index) ||
          this.src.get(s1, this.index) == -1
        ) {
    ...
    calculatePath: function () {
      ...
      while (_g1 < _g) {
        var j = _g1++
        if (
          (this.cost.get(j, this.index - 1) < best || bestj == -1) &&
          this.src.get(j, this.index - 1) != -1
        ) {
    ...
    toString: function () {
      ...
      while (_g1 < _g) {
        var i = _g1++
        if (this.path.get(0, i) == -1) txt += '*'
        else txt += this.path.get(0, i)
        if (this.K >= 10) txt += ' '
      }
  ...
  haxe.format.JsonParser.prototype = {
      ...
      while (true) {
        ...
        switch (c) {
          ...
          case 116:
            var save = this.pos
            if (
              StringTools.fastCodeAt(this.str, this.pos++) != 114 ||
              StringTools.fastCodeAt(this.str, this.pos++) != 117 ||
              StringTools.fastCodeAt(this.str, this.pos++) != 101
            ) {
              this.pos = save
              this.invalidChar()
            }
          ...
          case 102:
            var save1 = this.pos
            if (
              StringTools.fastCodeAt(this.str, this.pos++) != 97 ||
              StringTools.fastCodeAt(this.str, this.pos++) != 108 ||
              StringTools.fastCodeAt(this.str, this.pos++) != 115 ||
              StringTools.fastCodeAt(this.str, this.pos++) != 101
            ) {
              this.pos = save1
              this.invalidChar()
    ...
    parseNumber: function (c) {
      ...
      var f = Std.parseFloat(
        HxOverrides.substr(this.str, start, this.pos - start)
      )
      var i = f | 0
      if (i == f) return i
      else return f
  ...
  haxe.format.JsonPrinter.prototype = {
    ipad: function () {
      if (this.pretty) {
        var v = StringTools.lpad(
          '',
          this.indent,
          this.nind * this.indent.length
        )
        if (v == null) this.buf.b += 'null'
        else this.buf.b += '' + v
      }
    },
    write: function (k, v) {
      if (this.replacer != null) v = this.replacer(k, v)
      {
        ...
        switch (_g[1]) {
            ...
            if (c == String) this.quote(v)
              ...
              while ($it0.hasNext()) {
                ...
                Reflect.setField(
                  o,
                  k1,
                  __map_reserved[k1] != null ? v4.getReserved(k1) : v4.h[k1]
                )
              }
          ...
          case 7:
            ...
            var v6 = i1
            if (v6 == null) this.buf.b += 'null'
            else this.buf.b += '' + v6
            break
          case 3:
            var v7 = v
            if (v7 == null) this.buf.b += 'null'
            else this.buf.b += '' + v7
            break
          case 0:
            this.buf.b += 'null'
...
;(function () {
  ...
  if (typeof exports != 'undefined') {
    ...
    if (typeof exports['daff'] == 'undefined')
      exports['daff'] = exports['coopy']
...
;(function () {
  ...
  NdjsonTable.prototype.setCell = function (x, y, c) {
    ...
    if (y == 0) {
      if (key != null)
        throw Error('cannot yet change column set in this type of table')
      this.columns[x] = c
    } else {
